...
public class HttpClientUtil {
	 ...
	 * @return
	 */
	public static String httpPostWithJSON(String url, JSONObject jo) {
		...
		try {
			...
			if (jo != null) {
				StringEntity entity = new StringEntity(jo.toJSONString(), DEFAULT_CHARSET);// new
																						// StringEntity(JSONUtils.toJSONString(param),
																						// DEFAULT_CHARSET);//解决中文乱码问题
